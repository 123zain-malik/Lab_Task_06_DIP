...
2023-SE-02_Lab_Task_06_DIP

Write a complete Python program using NumPy, OpenCV, and Matplotlib, fully compatible with Google Colab, to demonstrate Frequency Domain Filtering in Digital Image Processing.
The program should perform the following tasks step by step:
...
Perform Inverse Fourier Transform (IFFT) to obtain:
